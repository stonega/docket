...
export default function Page() {
  return (
    <main className="min-h-screen flex flex-col items-center">
      <Header />
      <div className="mt-[6px] grow grid grid-cols-1 lg:grid-cols-2">
        <div className="py-4 bg-[#ff90ee] border-r border-black flex flex-col items-center justify-center">
          <span
          ...
          <span
            className="text-2xl md:text-2xl mt-16 mx-4 md:mx-28 font-serif text-center tracking-wide leading-relaxed"
          >
          ...
          <Link
            href="/home/"
            className="rounded-md mt-6 border flex font-bold flex-row items-center py-2 px-4 dark:text-white border-black bg-yellow-100 hover:border-yellow-100"
          >
            <Logo className="w-6 h-6 mr-4 text-white"></Logo>
            Enter My Docket
          </Link>
        </div>
        <div className="bg-[#ffc900] py-2 flex flex-col items-center justify-center">
          ...
          <span className="text-2xl md:text-2xl mt-16 mx-10 md:mx-28 font-serif dark:text-stone-100 text-center tracking-wide leading-relaxed">Use Chrome extension to save Highlight from web.</span>
          <div className="flex flex-row space-x-4 mt-6">
            <a
              href="https://chromewebstore.google.com/detail/docket-highlighter/pbnonpcfnmdbfmabpjfllgljbfkccjco"
              target="_blank"
              className="border font-bold rounded-md flex flex-row items-center px-4 py-2 dark:text-white border-black  hover:border-yellow-100 bg-yellow-100"
            >
