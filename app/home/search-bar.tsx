    ...
    <div className="sticky top-[62px] bg-[#ffc900] dark:bg-[#302a30] w-full py-12 mb-4 border-b border-black dark:border-white">
      <div className="relative container mx-auto px-6">
        ...
        {search ? (
          ...
          <kbd className="h-6 text-center absolute md:right-8 right-2 top-0 bottom-0 my-auto px-2 py-1.5 text-xs font-semibold text-gray-700 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500">
            Ctrl+k
          </kbd>
        )}
      </div>
