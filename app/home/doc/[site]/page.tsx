...
export default async function Page({
  ...
  if (!site) return null;
  return (
    <div className="grow border border-t-0 border-black dark:border-white pb-4 h-full container bg-cream-100 dark:bg-cream-900 mx-auto flex flex-col dark:text-white">
      <div className="border-b border-black bg-[#23a094] h-[62px] sticky top-[60px] px-4 w-full flex flex-row justify-between items-center">
        <BackButton>
          {site.icon ? (
            <Image
              alt={site.title}
