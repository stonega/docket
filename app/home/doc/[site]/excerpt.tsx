...
const Excerpt = ({ excerpt, onDelete }: { excerpt: Excerpt, onDelete(): void }) => {
  ...
  return (
    <>
      ...
      <div className="py-2" key={excerpt.id}>
        <article className="prose prose-stone lg:prose-xl dark:prose-invert prose-code:bg-orange-200 prose-code:before:content-[] prose-code:after:content-[] prose-code:px-1 prose-code:py-1 prose-code:text-stone-600 prose-code:rounded-lg">
