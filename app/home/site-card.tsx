...
export default function SiteCard({ site }: SiteCardProps) {
  ...
  return (
    <div
      key="record.id"
      className="group rounded-md w-full bg-cream-200 dark:text-white dark:bg-[#302a30] border justify-between border-black dark:border-white hover:bg-yellow-200 dark:hover:bg-yellow-700 cursor-pointer flex flex-col"
