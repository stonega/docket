/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: a4b9d567744850da948c80ba6c07530f)
...
interface __BaseEnv_CloudflareEnv {
	...
	WORKER_SELF_REFERENCE: Fetcher /* docket */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "NEXT_PUBLIC_CLERK_SIGN_IN_URL" | "NEXT_PUBLIC_CLERK_SIGN_UP_URL" | "NEXT_PUBLIC_CLERK_AFTER_SIGN_UP_URL">> {}
}
